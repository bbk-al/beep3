...
/* DECLS: OpenCL_NodeGroup(unsigned int num_patches);
 */
    static int __idx_OpenCL_NodeGroup_marshall1;
    static int ckNew(unsigned int num_patches) { return __idx_OpenCL_NodeGroup_marshall1; }
    static void _call_OpenCL_NodeGroup_marshall1(void* impl_msg,OpenCL_NodeGroup* impl_obj);
    static int _callmarshall_OpenCL_NodeGroup_marshall1(char* impl_buf,OpenCL_NodeGroup* impl_obj);
    static void _marshallmessagepup_OpenCL_NodeGroup_marshall1(PUP::er &p,void *msg);

/* DECLS: void run_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa);
 */
    static int __idx_run_bem_marshall2;
    static int run_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa) { return __idx_run_bem_marshall2; }
    static void _call_run_bem_marshall2(void* impl_msg,OpenCL_NodeGroup* impl_obj);
    static void _marshallmessagepup_run_bem_marshall2(PUP::er &p,void *msg);

/* DECLS: void collate_bem_results(const CkCallback &cb);
 */
    static int __idx_collate_bem_results_marshall3;
    static int collate_bem_results(const CkCallback &cb) { return __idx_collate_bem_results_marshall3; }
    static void _call_collate_bem_results_marshall3(void* impl_msg,OpenCL_NodeGroup* impl_obj);
    static void _marshallmessagepup_collate_bem_results_marshall3(PUP::er &p,void *msg);

/* DECLS: void precalc_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa);
 */
    static int __idx_precalc_bem_marshall4;
    static int precalc_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa) { return __idx_precalc_bem_marshall4; }
    static void _call_precalc_bem_marshall4(void* impl_msg,OpenCL_NodeGroup* impl_obj);
    static void _marshallmessagepup_precalc_bem_marshall4(PUP::er &p,void *msg);
...
/* DECLS: void run_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa);
 */
    void run_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa, const CkEntryOptions *impl_e_opts=NULL);

/* DECLS: void collate_bem_results(const CkCallback &cb);
 */
    void collate_bem_results(const CkCallback &cb, const CkEntryOptions *impl_e_opts=NULL);

/* DECLS: void precalc_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa);
 */
    void precalc_bem(const CkArrayIndexOctreeIndexer &idxer, double kappa, const CkEntryOptions *impl_e_opts=NULL);
...
/* DECLS: OpenCL_NodeGroup(unsigned int num_patches);
 */
    static CkGroupID ckNew(unsigned int num_patches, const CkEntryOptions *impl_e_opts=NULL);
    CProxy_OpenCL_NodeGroup(unsigned int num_patches, const CkEntryOptions *impl_e_opts=NULL);
