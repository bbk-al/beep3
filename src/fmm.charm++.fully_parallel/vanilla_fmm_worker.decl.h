...
/* DECLS: void evaluate(Eval_Message* impl_msg);
 */
...
/* DECLS: threaded void asynchronous_check(int impl_noname_0);
 */
    static int __idx_asynchronous_check_marshall5;
    static int asynchronous_check(int impl_noname_0) { return __idx_asynchronous_check_marshall5; }
    static void _call_asynchronous_check_marshall5(void* impl_msg,VanillaFMMWorkerT < NTERMS, NLAMBS, NWAVES > * impl_obj);
    static void _callthr_asynchronous_check_marshall5(CkThrCallArg *);
    static void _marshallmessagepup_asynchronous_check_marshall5(PUP::er &p,void *msg);

/* DECLS: void check_waves_complete(int impl_noname_1);
 */
    static int __idx_check_waves_complete_marshall6;
    static int check_waves_complete(int impl_noname_1) { return __idx_check_waves_complete_marshall6; }
    static void _call_check_waves_complete_marshall6(void* impl_msg,VanillaFMMWorkerT < NTERMS, NLAMBS, NWAVES > * impl_obj);
    static int _callmarshall_check_waves_complete_marshall6(char* impl_buf,VanillaFMMWorkerT < NTERMS, NLAMBS, NWAVES > * impl_obj);
    static void _marshallmessagepup_check_waves_complete_marshall6(PUP::er &p,void *msg);
...
/* DECLS: void solve(double impl_noname_2, const CkCallback &impl_noname_3);
 */
    static int __idx_solve_marshall9;
    static int solve(double impl_noname_2, const CkCallback &impl_noname_3) { return __idx_solve_marshall9; }
    static void _call_solve_marshall9(void* impl_msg,VanillaFMMWorkerT < NTERMS, NLAMBS, NWAVES > * impl_obj);
    static int _callmarshall_solve_marshall9(char* impl_buf,VanillaFMMWorkerT < NTERMS, NLAMBS, NWAVES > * impl_obj);
    static void _marshallmessagepup_solve_marshall9(PUP::er &p,void *msg);

/* DECLS: void make_plane_waves(int dummy);
 */
    static int __idx_make_plane_waves_marshall10;
    static int make_plane_waves(int dummy) { return __idx_make_plane_waves_marshall10; }
    static void _call_make_plane_waves_marshall10(void* impl_msg,VanillaFMMWorkerT < NTERMS, NLAMBS, NWAVES > * impl_obj);
    static int _callmarshall_make_plane_waves_marshall10(char* impl_buf,VanillaFMMWorkerT < NTERMS, NLAMBS, NWAVES > * impl_obj);
    static void _marshallmessagepup_make_plane_waves_marshall10(PUP::er &p,void *msg);
...
/* DECLS: threaded void asynchronous_check(int impl_noname_0);
 */
    void asynchronous_check(int impl_noname_0, const CkEntryOptions *impl_e_opts=NULL) ;

/* DECLS: void check_waves_complete(int impl_noname_1);
 */
    void check_waves_complete(int impl_noname_1, const CkEntryOptions *impl_e_opts=NULL) ;
...
/* DECLS: void solve(double impl_noname_2, const CkCallback &impl_noname_3);
 */
    void solve(double impl_noname_2, const CkCallback &impl_noname_3, const CkEntryOptions *impl_e_opts=NULL) ;
